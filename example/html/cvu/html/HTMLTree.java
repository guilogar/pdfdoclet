 ...
 * be performed. <a href="http://www.jlaby.com">The nature of</a> 
 * the searches are described below, but some
 * of their uses are highlighted here: <p>
 * <ul>
 * <li>Subtree - Finding all of the FORM elements within a BODY element.</li>
 * <li>Sibling - Finding all the LI elements within the same UL element.</li>
 * <li>All - Finding every occurence of the A element.</li>
 * </ul>
